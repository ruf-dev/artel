module github.com/ruf-dev/artel-embed-example
...
require (
	...
	github.com/go-kivik/kivik/v4 v4.5.2 // indirect
	...
	go.vervstack.ru/matreshka v1.0.100 // indirect
...
replace github.com/ruf-dev/artel => ../../..
