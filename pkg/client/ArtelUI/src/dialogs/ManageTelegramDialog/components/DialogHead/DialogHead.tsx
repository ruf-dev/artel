...
import cls from "@/dialogs/ManageTelegramDialog/components/DialogHead/DialogHead.module.css"
        ...
        <div className={cls.DialogHeadContainer}>
            <div className={cls.ModalHeadLeft}>
                <div className={cls.ModalIcon}>
                    <ProviderIcon provider={ExternalProvider.EXTERNAL_PROVIDER_TELEGRAM}/>
                </div>
                <span className={cls.ModalTitle}>Telegram</span>
            </div>
