...
type VaultMembersRepo struct {
	q *artel_q.Queries
}

func New(q *artel_q.Queries) *VaultMembersRepo {
	return &VaultMembersRepo{
		q: q,
	}
}

func (r *VaultMembersRepo) Add(ctx context.Context, vaultUuid, userUuid uuid.UUID, role string) error {
...
func (r *VaultMembersRepo) Remove(ctx context.Context, vaultUuid, userUuid uuid.UUID) error {
...
func (r *VaultMembersRepo) Get(ctx context.Context, vaultUuid, userUuid uuid.UUID) (domain.VaultMember, error) {
...
func (r *VaultMembersRepo) ListByVault(ctx context.Context, vaultUuid uuid.UUID) ([]domain.VaultMember, error) {
