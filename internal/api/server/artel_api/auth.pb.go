...
type TelegramMiniAppCredentials struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *TelegramMiniAppCredentials) Reset() {
	*x = TelegramMiniAppCredentials{}
	mi := &file_auth_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TelegramMiniAppCredentials) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TelegramMiniAppCredentials) ProtoMessage() {}

func (x *TelegramMiniAppCredentials) ProtoReflect() protoreflect.Message {
	mi := &file_auth_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TelegramMiniAppCredentials.ProtoReflect.Descriptor instead.
func (*TelegramMiniAppCredentials) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{2}
}

func (x *TelegramMiniAppCredentials) GetInitData() string {
	if x != nil {
		return x.InitData
	}
	return ""
...
func (x *Login_Request) GetMiniApp() *TelegramMiniAppCredentials {
	if x != nil {
		if x, ok := x.Method.(*Login_Request_MiniApp); ok {
			return x.MiniApp
		}
	}
	return nil
...
type Login_Request_MiniApp struct {
	MiniApp *TelegramMiniAppCredentials `protobuf:"bytes,3,opt,name=mini_app,json=miniApp,proto3,oneof"`
}
...
func (*Login_Request_MiniApp) isLogin_Request_Method() {}
...
func (*GetMe_Response) Descriptor() ([]byte, []int) {
	return file_auth_proto_rawDescGZIP(), []int{9, 1}
}
...
const file_auth_proto_rawDesc = "" +
	...
	"\x1aTelegramMiniAppCredentials\x12\x1b\n" +
	"\tinit_data\x18\x01 \x01(\tR\binitData\"y\n" +
	"\bRegister\x1a;\n" +
	"\aRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	...
	"\x05email\x18\x02 \x01(\tR\x05email\"\xad\x03\n" +
	"\x05Login\x1a\xd6\x01\n" +
	"\aRequest\x12=\n" +
	"\bpassword\x18\x01 \x01(\v2\x1f.artel_auth.PasswordCredentialsH\x00R\bpassword\x12=\n" +
	"\btelegram\x18\x02 \x01(\v2\x1f.artel_auth.TelegramCredentialsH\x00R\btelegram\x12C\n" +
	"\bmini_app\x18\x03 \x01(\v2&.artel_auth.TelegramMiniAppCredentialsH\x00R\aminiAppB\b\n" +
...
var file_auth_proto_goTypes = []any{
	...
	(*TelegramMiniAppCredentials)(nil), // 2: artel_auth.TelegramMiniAppCredentials
	(*Register)(nil),                   // 3: artel_auth.Register
	(*Login)(nil),                      // 4: artel_auth.Login
	(*Logout)(nil),                     // 5: artel_auth.Logout
	(*Refresh)(nil),                    // 6: artel_auth.Refresh
	(*GetConfig)(nil),                  // 7: artel_auth.GetConfig
	(*Permissions)(nil),                // 8: artel_auth.Permissions
	(*GetMe)(nil),                      // 9: artel_auth.GetMe
	(*Register_Request)(nil),           // 10: artel_auth.Register.Request
	(*Register_Response)(nil),          // 11: artel_auth.Register.Response
	(*Login_Request)(nil),              // 12: artel_auth.Login.Request
	(*Login_Response)(nil),             // 13: artel_auth.Login.Response
	(*Logout_Request)(nil),             // 14: artel_auth.Logout.Request
	(*Logout_Response)(nil),            // 15: artel_auth.Logout.Response
	(*Refresh_Request)(nil),            // 16: artel_auth.Refresh.Request
	(*Refresh_Response)(nil),           // 17: artel_auth.Refresh.Response
	(*GetConfig_Request)(nil),          // 18: artel_auth.GetConfig.Request
	(*GetConfig_Response)(nil),         // 19: artel_auth.GetConfig.Response
	(*GetMe_Request)(nil),              // 20: artel_auth.GetMe.Request
	(*GetMe_Response)(nil),             // 21: artel_auth.GetMe.Response
...
var file_auth_proto_depIdxs = []int32{
	...
	2,  // 2: artel_auth.Login.Request.mini_app:type_name -> artel_auth.TelegramMiniAppCredentials
	22, // 3: artel_auth.Login.Response.expires_at:type_name -> google.protobuf.Timestamp
	22, // 4: artel_auth.Login.Response.refresh_expires_at:type_name -> google.protobuf.Timestamp
	22, // 5: artel_auth.Refresh.Response.expires_at:type_name -> google.protobuf.Timestamp
	22, // 6: artel_auth.Refresh.Response.refresh_expires_at:type_name -> google.protobuf.Timestamp
	8,  // 7: artel_auth.GetMe.Response.permissions:type_name -> artel_auth.Permissions
	10, // 8: artel_auth.AuthAPI.Register:input_type -> artel_auth.Register.Request
	12, // 9: artel_auth.AuthAPI.Login:input_type -> artel_auth.Login.Request
	14, // 10: artel_auth.AuthAPI.Logout:input_type -> artel_auth.Logout.Request
	16, // 11: artel_auth.AuthAPI.Refresh:input_type -> artel_auth.Refresh.Request
	18, // 12: artel_auth.AuthAPI.GetConfig:input_type -> artel_auth.GetConfig.Request
	20, // 13: artel_auth.AuthAPI.GetMe:input_type -> artel_auth.GetMe.Request
	11, // 14: artel_auth.AuthAPI.Register:output_type -> artel_auth.Register.Response
	13, // 15: artel_auth.AuthAPI.Login:output_type -> artel_auth.Login.Response
	15, // 16: artel_auth.AuthAPI.Logout:output_type -> artel_auth.Logout.Response
	17, // 17: artel_auth.AuthAPI.Refresh:output_type -> artel_auth.Refresh.Response
	19, // 18: artel_auth.AuthAPI.GetConfig:output_type -> artel_auth.GetConfig.Response
	21, // 19: artel_auth.AuthAPI.GetMe:output_type -> artel_auth.GetMe.Response
