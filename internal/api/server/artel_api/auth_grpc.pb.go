...
func (c *authAPIClient) GetMe(ctx context.Context, in *GetMe_Request, opts ...grpc.CallOption) (*GetMe_Response, error) {
	out := new(GetMe_Response)
	err := c.cc.Invoke(ctx, AuthAPI_GetMe_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthAPIServer) GetMe(context.Context, *GetMe_Request) (*GetMe_Response, error) {
...
func _AuthAPI_GetMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMe_Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthAPIServer).GetMe(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthAPI_GetMe_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthAPIServer).GetMe(ctx, req.(*GetMe_Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMe",
			Handler:    _AuthAPI_GetMe_Handler,
		},
	},
