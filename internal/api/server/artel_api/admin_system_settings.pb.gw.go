...
func request_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0(ctx context.Context, marshaler runtime.Marshaler, client AdminSystemSettingsAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateDefaultDocsVault_Request
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateDefaultDocsVault(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0(ctx context.Context, marshaler runtime.Marshaler, server AdminSystemSettingsAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateDefaultDocsVault_Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateDefaultDocsVault(ctx, &protoReq)
	return msg, metadata, err

}

func request_AdminSystemSettingsAPI_UpdateSystemPrompt_0(ctx context.Context, marshaler runtime.Marshaler, client AdminSystemSettingsAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateSystemPrompt_Request
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateSystemPrompt(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AdminSystemSettingsAPI_UpdateSystemPrompt_0(ctx context.Context, marshaler runtime.Marshaler, server AdminSystemSettingsAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateSystemPrompt_Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateSystemPrompt(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAdminSystemSettingsAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AdminSystemSettingsAPIServer) error {
	...
	mux.Handle("POST", pattern_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/artel_admin_system_settings.AdminSystemSettingsAPI/UpdateDefaultDocsVault", runtime.WithHTTPPathPattern("/api/admin_system_settings/update_default_docs_vault"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_AdminSystemSettingsAPI_UpdateSystemPrompt_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/artel_admin_system_settings.AdminSystemSettingsAPI/UpdateSystemPrompt", runtime.WithHTTPPathPattern("/api/admin_system_settings/update_system_prompt"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AdminSystemSettingsAPI_UpdateSystemPrompt_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AdminSystemSettingsAPI_UpdateSystemPrompt_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAdminSystemSettingsAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AdminSystemSettingsAPIClient) error {
	...
	mux.Handle("POST", pattern_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/artel_admin_system_settings.AdminSystemSettingsAPI/UpdateDefaultDocsVault", runtime.WithHTTPPathPattern("/api/admin_system_settings/update_default_docs_vault"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_AdminSystemSettingsAPI_UpdateSystemPrompt_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/artel_admin_system_settings.AdminSystemSettingsAPI/UpdateSystemPrompt", runtime.WithHTTPPathPattern("/api/admin_system_settings/update_system_prompt"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AdminSystemSettingsAPI_UpdateSystemPrompt_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "admin_system_settings", "update_default_docs_vault"}, ""))

	pattern_AdminSystemSettingsAPI_UpdateSystemPrompt_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "admin_system_settings", "update_system_prompt"}, ""))
)
...
var (
	...
	forward_AdminSystemSettingsAPI_UpdateDefaultDocsVault_0 = runtime.ForwardResponseMessage

	forward_AdminSystemSettingsAPI_UpdateSystemPrompt_0 = runtime.ForwardResponseMessage
)
