...
func WithMomToolHttpMiddleware(tool executors.McpTool, mw executors.HttpMiddleware) Option {
...
func WithMomMcpHttpMiddleware(mcp executors.McpName, mw executors.HttpMiddleware) Option {
	return func(cfg *svcConfig) {
